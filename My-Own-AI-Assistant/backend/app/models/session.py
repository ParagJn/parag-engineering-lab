...
class Session(BaseModel):
    ...
    project_id: Optional[str] = Field(default=None, description="Project this chat belongs to, if any")
    ...
    attachment_ids: list[str] = Field(default_factory=list, description="Files uploaded in this chat")
