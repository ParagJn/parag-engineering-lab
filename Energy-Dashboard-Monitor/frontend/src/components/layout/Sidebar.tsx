    ...
    <aside className="w-[280px] h-screen fixed left-0 top-0 flex flex-col bg-surface border-r border-outline-variant shadow-sm z-50">
      <div className="flex flex-col gap-unit py-container-margin h-full">
        ...
        <div className="px-6 mb-8 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-headline-md text-headline-md font-bold tracking-tight text-primary">GridData OS</h1>
        ...
        <nav className="flex-1 px-4 space-y-1">
          <NavLink 
            to="/"
            className={({ isActive }) => 
              `flex items-center gap-3 px-4 py-3 font-label-md text-label-md rounded-lg transition-colors duration-150 ${
                isActive 
